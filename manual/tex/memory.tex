...
\begin{itemize}
	\item Kseg0 (\field{SEGNO} 0 and 1) is the 2GB segment for the OS \uline{text}, \uline{data}, stacks, as well as the ROM code and device registers that sit at the beginning of this segment.
	\item Useg2 (\field{SEGNO} 2) is the 1GB virtual address space for the use of User mode processes as privarte memory region.
